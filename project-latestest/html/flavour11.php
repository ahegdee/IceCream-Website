...
<head>
    ...
    <link rel="stylesheet" href="../css/flavour.css" type="text/css">
...
<body>
    ...
    <section class="icecream-container">
        <div class="container">
            <div class="it1">
                <img class="main q" src="../img/11b.jpeg">
                <img class="pic q" src="../img/11a.jpeg">
                <img class="pic q" src="../img/11.jpeg">
            </div>
            <div class="it2">
                <h4 class="head">BROWN BUTTER ALMOND BRITTLE</h4>
                <h2 class="desc">When Ohio strawberries are at their peak—juicy, fragrant, with a tart edge—we buy up thousands of pounds per week from neighboring farms. Beautiful strawberries so high in sugar and low in water content that they have flavor for days. Jeni always says creating the best ice cream is about pairing the right dairy with the right ingredients. We use fresh cultured buttermilk—sourced from our friends at Arps Dairy in Ohio—to complement the natural acidity of the berries for a flavor that’s always springy, bright, and popping with fresh strawberry flavor.</h2>
            </div>
